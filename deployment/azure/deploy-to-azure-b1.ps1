# PowerShell deployment script for Azure App Service (Basic B1 Tier)
# Use this if Free tier (F1) quota is not available
# Cost: ~$13/month (or $0.43-$2/month with start/stop scripts)

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "  Church Presentation App - Azure Deploy" -ForegroundColor Cyan
Write-Host "  Using Basic B1 Tier (Low Cost)" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "   - 24/7 running:         `$13.14/month"
Write-Host "   - Sunday only (3 hrs):  `$0.43/month  ⭐ Recommended"
Write-Host "   - Sun + Wed (6 hrs):    `$1.08/month"
Write-Host ""
Write-Host "   Use start/stop scripts to minimize costs!" -ForegroundColor Green
Write-Host ""
...
Write-Host "📋 Creating App Service Plan (Basic B1 Tier)..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "📊 Check costs anytime:" -ForegroundColor Cyan
